          ...
          <div className="space-y-16">
            ...
            <div className="animate-fade-slide animate-delay-400">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">5 loại câu hỏi đa dạng và hấp dẫn</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {/* Multiple Choice */}
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(0); }}>
                  <div className="text-center mb-4">
                    <span className="text-5xl mb-2 block">📝</span>
                    <h3 className="text-xl font-bold text-white mb-2">Trắc nghiệm</h3>
                    <p className="text-sm text-gray-400">Chọn đáp án đúng từ 4 lựa chọn</p>
                  </div>
                  <div className="space-y-2">
                    <div className="bg-white/5 border border-white/20 rounded-lg p-2 text-white text-sm">A. 162</div>
                    <div className="bg-green-500/20 border-2 border-green-500 rounded-lg p-2 text-green-300 text-sm flex items-center justify-between">
                      <span>B. 172</span>
                ...
                {/* Text Input */}
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(1); }}>
                  <div className="text-center mb-4">
                    <span className="text-5xl mb-2 block">✍️</span>
                    <h3 className="text-xl font-bold text-white mb-2">Tự luận</h3>
                    <p className="text-sm text-gray-400">Nhập trực tiếp đáp án</p>
                  </div>
                  <input
                    type="text"
                    placeholder="Nhập đáp án..."
                    className="w-full px-4 py-3 rounded-lg bg-white/10 border-2 border-white/20 text-white text-center placeholder-gray-400"
                    disabled
                  />
                  <button className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-white font-semibold py-2 rounded-lg mt-3" disabled>
                    ✓ Gửi đáp án
                  </button>
                </div>

                {/* True/False */}
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(2); }}>
                  <div className="text-center mb-4">
                    <span className="text-5xl mb-2 block">✓✗</span>
                    <h3 className="text-xl font-bold text-white mb-2">Đúng/Sai</h3>
                    <p className="text-sm text-gray-400">Chọn đúng hoặc sai</p>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-green-500/20 border-2 border-green-500 rounded-lg p-3 text-center">
                      <span className="text-3xl text-green-400">✓</span>
                      <p className="text-green-300 font-bold text-sm mt-1">ĐÚNG</p>
                    </div>
                    <div className="bg-white/5 border border-white/20 rounded-lg p-3 text-center">
                      <span className="text-3xl text-white">✗</span>
                      <p className="text-white font-bold text-sm mt-1">SAI</p>
                    </div>
                  </div>
                </div>

                {/* Matching */}
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(3); }}>
                  <div className="text-center mb-4">
                    <span className="text-5xl mb-2 block">🔗</span>
                    <h3 className="text-xl font-bold text-white mb-2">Ghép cột</h3>
                    <p className="text-sm text-gray-400">Nối cột A với cột B</p>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-blue-500/20 border border-blue-500 rounded-lg p-2 text-white text-sm">5 × 6</div>
                    <div className="bg-purple-500/20 border border-purple-500 rounded-lg p-2 text-white text-sm">30</div>
                  </div>
                </div>

                {/* Ordering */}
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(4); }}>
                  <div className="text-center mb-4">
                    <span className="text-5xl mb-2 block">🔢</span>
                    <h3 className="text-xl font-bold text-white mb-2">Sắp xếp</h3>
                    <p className="text-sm text-gray-400">Kéo thả để sắp xếp</p>
                  </div>
                  <div className="space-y-2">
                    {['1. 47', '2. 89', '3. 125'].map((item, i) => (
                      <div key={i} className="bg-white/10 border border-white/20 rounded-lg p-2 text-white text-sm flex items-center justify-between">
                        <span>{item}</span>
