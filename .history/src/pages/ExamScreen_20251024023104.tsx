...
const mockExams: Exam[] = [
  ...
  { id: 2, name: 'Kiểm tra 45 phút', type: 'system', subject: 'Tiếng Việt', chapter: 'Chương 2', lesson: 'Bài 2', duration: 45, questionCount: 20, grade: 'Lớp 3', examType: '45min' },
  ...
  { id: 4, name: 'Kiểm tra Cuối kỳ', type: 'system', subject: 'Tiếng Việt', chapter: 'Học kỳ 1', lesson: 'Tổng hợp', duration: 90, questionCount: 30, grade: 'Lớp 3', examType: 'final' },
  ...
  { id: 6, name: 'Tổng hợp kiến thức (AI)', type: 'ai', subject: 'Tiếng Việt', chapter: 'Chương 1', lesson: 'Tổng hợp', duration: 30, questionCount: 20, grade: 'Lớp 3', examType: 'review' },
