        ...
        <div className="space-y-16">
          ...
          <div className="animate-fade-slide animate-delay-400">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">5 loại câu hỏi đa dạng và hấp dẫn với timer và streak</p>
            </div>
          ...
          <div className="animate-fade-slide animate-delay-800">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-gray-900 mb-2">5️⃣ Kết quả chung cuộc</h2>
