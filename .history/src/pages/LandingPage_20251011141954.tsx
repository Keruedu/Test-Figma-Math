        ...
        <div className="space-y-12 md:space-y-16">
          ...
          <div className="animate-fade-slide animate-delay-500">
            <div className="text-center mb-6 md:mb-8 px-4">
              ...
              <p className="text-sm md:text-base text-gray-600">Xem thứ hạng sau mỗi câu hỏi</p>
            </div>
            <div
              className="max-w-4xl mx-auto bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer"
          ...
          <div className="animate-fade-slide animate-delay-600">
            <div className="text-center mb-6 md:mb-8 px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">4️⃣ Thanh toán gói học</h2>
              <p className="text-sm md:text-base text-gray-600">Chọn gói phù hợp để nâng cao kỹ năng toán học</p>
            </div>
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
                {/* Gói Cơ bản */}
                <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg border-2 border-gray-200 hover:scale-105 transition-all">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Gói Cơ bản</h3>
                  <div className="mb-6">
                  ...
                  <p className="text-xs md:text-sm text-gray-500 mb-4">Phù hợp cho học sinh mới bắt đầu</p>
                  <button className="w-full bg-gray-100 text-gray-900 font-bold py-3 rounded-xl hover:bg-gray-200 transition-all">
                    Chọn gói
                  </button>
                </div>

                {/* Gói Nâng cao - POPULAR */}
                <div className="bg-gradient-to-br from-[#6E55FB] to-[#8b6fff] rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl border-2 border-[#6E55FB] transform scale-105 md:scale-110 relative">
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-1 rounded-full text-xs md:text-sm font-bold shadow-lg">
                    PHỔ BIẾN NHẤT
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Gói Nâng cao</h3>
                  <div className="mb-6">
                    <span className="text-4xl md:text-5xl font-black text-white">249.000đ</span>
                  </div>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-2 text-sm md:text-base">
                      <span className="text-yellow-300">💰</span>
                      <span className="text-white">300 coins</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm md:text-base">
                      <span className="text-blue-300">✏️</span>
                      <span className="text-white">200 lượt hỏi đáp</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm md:text-base">
                      <span className="text-green-300">📝</span>
                      <span className="text-white">500 lượt sinh bài tập</span>
                    </div>
                  </div>
                  <p className="text-xs md:text-sm text-purple-100 mb-4">Dành cho học sinh muốn nâng cao kiến thức</p>
                  <button className="w-full bg-white text-[#6E55FB] font-bold py-3 rounded-xl hover:bg-gray-100 transition-all shadow-lg">
                    Chọn gói ngay
                  </button>
                </div>

                {/* Gói Premium */}
                <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg border-2 border-yellow-400 hover:scale-105 transition-all">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Gói Premium</h3>
                  <div className="mb-6">
                    <span className="text-4xl md:text-5xl font-black bg-gradient-to-r from-yellow-500 to-orange-500 bg-clip-text text-transparent">399.000đ</span>
                  </div>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-2 text-sm md:text-base">
                      <span className="text-yellow-500">💰</span>
                  ...
                  <p className="text-xs md:text-sm text-gray-500 mb-4">Gói cao cấp, học tập thoải mái</p>
                  <button className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-bold py-3 rounded-xl hover:shadow-lg transition-all">
                    Chọn gói
                  </button>
                </div>
              </div>
              ...
              {/* Payment Methods */}
              <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg border border-gray-200 mb-8">
                <h4 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Phương thức thanh toán</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-4 p-4 rounded-xl border-2 border-[#6E55FB] bg-purple-50 cursor-pointer hover:bg-purple-100 transition-all">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-gray-300 cursor-pointer hover:bg-gray-50 transition-all">
                ...
                <button className="w-full mt-6 bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-white font-bold py-3 md:py-4 rounded-xl hover:shadow-lg hover:shadow-[#6E55FB]/50 transition-all text-sm md:text-base">
                  Xác nhận thanh toán
                </button>
              </div>
            </div>
          ...
          <div className="animate-fade-slide animate-delay-700">
            <div className="text-center mb-6 md:mb-8 px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">5️⃣ Đổi Token AI</h2>
              <p className="text-sm md:text-base text-gray-600">Dùng điểm thưởng để đổi token sinh đề kiểm tra</p>
            </div>
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-br from-orange-50 via-yellow-50 to-orange-50 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl border-2 border-orange-300">
                {/* Current Balance */}
                <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 mb-6 shadow-lg">
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-3xl md:text-4xl">🤖</span>
                        <span className="text-3xl md:text-4xl font-black text-orange-500">25</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white rounded-xl p-4 md:p-6 shadow-lg border-2 border-transparent hover:border-orange-400 transition-all cursor-pointer group">
                    <div className="text-center">
                      <div className="text-4xl md:text-5xl mb-3">🥉</div>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Gói Cơ bản</h4>
                      <div className="mb-4">
                        <span className="text-2xl md:text-3xl font-black text-orange-500">5 tokens</span>
                      </div>
                      <div className="flex items-center justify-center gap-2 mb-4">
                        <span className="text-xl md:text-2xl">🏆</span>
                        <span className="text-xl md:text-2xl font-bold text-gray-700">100 điểm</span>
                      </div>
                      <button className="w-full bg-gray-100 text-gray-900 font-bold py-2 rounded-lg group-hover:bg-orange-500 group-hover:text-white transition-all text-sm md:text-base">
                        Đổi ngay
                      </button>
                    </div>
                  </div>

                  <div className="bg-gradient-to-br from-orange-100 to-yellow-100 rounded-xl p-4 md:p-6 shadow-xl border-2 border-orange-400 transform scale-105 relative">
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-orange-500 to-red-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                      HOT
                    </div>
                    <div className="text-center">
                      <div className="text-4xl md:text-5xl mb-3">🥈</div>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Gói Tiết kiệm</h4>
                      <div className="mb-4">
                        <span className="text-2xl md:text-3xl font-black text-orange-600">15 tokens</span>
                      </div>
                      <div className="flex items-center justify-center gap-2 mb-4">
                        <span className="text-xl md:text-2xl">🏆</span>
                        <span className="text-xl md:text-2xl font-bold text-gray-700">250 điểm</span>
                        <span className="text-xs bg-red-500 text-white px-2 py-0.5 rounded-full">-17%</span>
                      </div>
                      <button className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-2 rounded-lg hover:shadow-lg transition-all text-sm md:text-base">
                        Đổi ngay
                      </button>
                    </div>
                  </div>

                  <div className="bg-white rounded-xl p-4 md:p-6 shadow-lg border-2 border-transparent hover:border-yellow-400 transition-all cursor-pointer group">
                    <div className="text-center">
                      <div className="text-4xl md:text-5xl mb-3">🥇</div>
                      <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Gói Cao cấp</h4>
                      <div className="mb-4">
                        <span className="text-2xl md:text-3xl font-black bg-gradient-to-r from-yellow-500 to-orange-500 bg-clip-text text-transparent">50 tokens</span>
                      </div>
                      <div className="flex items-center justify-center gap-2 mb-4">
                        <span className="text-xl md:text-2xl">🏆</span>
                        <span className="text-xl md:text-2xl font-bold text-gray-700">750 điểm</span>
                        <span className="text-xs bg-red-500 text-white px-2 py-0.5 rounded-full">-25%</span>
                      </div>
                      <button className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-bold py-2 rounded-lg group-hover:shadow-lg transition-all text-sm md:text-base">
                        Đổi ngay
                      </button>
                    </div>
                  </div>
                ...
                {/* Earning Points */}
                <div className="mt-6 bg-white rounded-xl p-4 md:p-6 border-2 border-green-200">
                  <div className="flex items-start gap-3">
                    <span className="text-2xl md:text-3xl">🎯</span>
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs md:text-sm">
                        <div className="flex items-center gap-2">
                          <span className="bg-green-100 text-green-700 px-2 py-1 rounded font-bold">+100</span>
                          <span className="text-gray-700">Thắng 1 trận đấu</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded font-bold">+50</span>
                          <span className="text-gray-700">Streak 5 câu liên tiếp</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="bg-yellow-100 text-yellow-700 px-2 py-1 rounded font-bold">+200</span>
                          <span className="text-gray-700">Top 1 bảng xếp hạng</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded font-bold">+25</span>
