...
export default function ExamCard({ exam, onSelectExam, onRetakeExam, onViewResult }: ExamCardProps) {
  return (
    <div className="bg-white border-2 border-gray-200 rounded-3xl p-6 hover:border-[#6E55FB] hover:shadow-2xl transition-all hover:scale-105 relative overflow-hidden group">
      {/* Badge AI */}
      {exam.type === 'ai' && (
