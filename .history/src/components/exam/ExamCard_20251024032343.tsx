...
export default function ExamCard({ exam, onSelectExam, onRetakeExam, onViewResult }: ExamCardProps) {
  ...
  return (
    <div className={`border-2 rounded-3xl p-8 transition-all hover:scale-[1.02] relative overflow-hidden group ${
      exam.completed 
      ...
      {/* Icon môn học - To hơn, nổi bật hơn */}
      ...
      {/* Loại kiểm tra - Badge nhỏ màu nhạt */}
      <div className="mb-3">
        <span className="inline-block bg-purple-100 text-[#6E55FB] px-4 py-1.5 rounded-full text-sm font-bold">
          {examTypeLabels[exam.examType] || exam.examType}
        </span>
      </div>

      {/* Tên bài kiểm tra - PHẦN CHÍNH, TO, ĐẬM */}
      <h3 className="text-3xl font-extrabold text-gray-900 mb-5 leading-tight">{exam.name}</h3>
      
      {/* Thông tin chi tiết - Spacing đồng đều */}
      <div className="space-y-3 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-base text-gray-600">
              <span className="font-bold text-gray-900">Chương:</span> {exam.chapter}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-base text-gray-600">
              <span className="font-bold text-gray-900">Thời gian:</span> {exam.duration} phút
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-base text-gray-600">
              <span className="font-bold text-gray-900">Số câu:</span> {exam.questionCount} câu
            </p>
          </div>
        </div>

        {/* Điểm số - Nổi bật với màu xanh */}
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-gray-200">
            ...
            <div className="flex-1">
              <p className="text-base font-bold text-green-600">
                Điểm: {exam.score}/{exam.questionCount * 2}
              </p>
            </div>
          </div>
        )}

        {/* Ngày hoàn thành - Nhỏ hơn */}
      ...
      {exam.completed ? (
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-[#6E55FB] to-purple-600 text-white text-center py-4 rounded-2xl font-bold text-lg hover:from-[#5d47d4] hover:to-purple-700 transition-all hover:scale-105 shadow-lg flex items-center justify-center gap-2"
        >
          Bắt đầu làm bài
