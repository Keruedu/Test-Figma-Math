...
export default function ExamCard({ exam, onSelectExam, onRetakeExam, onViewResult }: ExamCardProps) {
  ...
  return (
    <div className={`border-2 rounded-3xl p-8 transition-all hover:scale-[1.02] relative overflow-hidden group flex flex-col ${
      ...
      {/* Badge loại kiểm tra và Tên bài - CÙNG HÀNG */}
      ...
      {/* Thông tin chi tiết - Flex-grow để đẩy nút xuống dưới */}
      <div className="space-y-3 mb-6 flex-grow">
        {/* Hàng 1: Chương và Thời gian */}
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-purple-100 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-[#6E55FB]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <p className="text-sm text-gray-600">
              <span className="font-bold text-gray-900">{exam.chapter}</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-gray-600">
              <span className="font-bold text-gray-900">{exam.questionCount} câu</span>
            </p>
          </div>
        ...
        {/* Ngày hoàn thành - hàng riêng nếu có */}
      ...
      {/* Nút hành động - CHỈ ICON, Ở DƯỚI CÙNG */}
      {exam.completed ? (
        <div className="flex items-center justify-end gap-2 pt-4 border-t border-gray-200 mt-auto">
          <button
            onClick={() => onRetakeExam(exam)}
            className="w-12 h-12 bg-[#6E55FB] text-white rounded-xl hover:bg-[#5d47d4] transition-all hover:scale-110 shadow-lg flex items-center justify-center"
            title="Làm lại"
          >
          ...
          <button
            ...
            className="w-12 h-12 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-all hover:scale-110 shadow-lg flex items-center justify-center"
            title="Xem chi tiết"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
        ...
        <div className="flex items-center justify-end pt-4 border-t border-gray-200 mt-auto">
          <button
            ...
            className="w-12 h-12 bg-gradient-to-r from-[#6E55FB] to-purple-600 text-white rounded-xl hover:from-[#5d47d4] hover:to-purple-700 transition-all hover:scale-110 shadow-lg flex items-center justify-center"
