      ...
      <div className="mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div className="inline-flex gap-4 bg-gray-100 rounded-2xl p-2">
              <button
                onClick={() => {
            ...
            {/* Nút Tạo bài kiểm tra AI - chỉ hiện khi tab AI được chọn */}
            {selectedTab === 'ai' && onCreateAIExam && (
              <button
                onClick={onCreateAIExam}
                className="px-6 py-4 bg-gradient-to-r from-[#6E55FB] to-purple-600 text-white text-lg font-bold rounded-2xl hover:from-[#5d47d4] hover:to-purple-700 transition-all hover:scale-105 shadow-lg flex items-center gap-3"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
