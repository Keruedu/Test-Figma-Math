  ...
  return (
    <div className={`border-2 rounded-3xl p-8 transition-all hover:scale-[1.02] relative overflow-hidden group flex flex-col ${
      ...
      <div className='flex flex-row gap-2'>
        <div className="w-20 bg-gradient-to-br from-[#6E55FB] to-purple-600 rounded-3xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-lg">
