    ...
    <div className={`border-2 rounded-3xl p-8 transition-all hover:scale-[1.02] relative overflow-hidden group flex flex-col ${
      ...
      <div className='flex flex-row gap-2'>
        ...
        <div className="flex flex-col mb-5">
            <h3 className="text-2xl font-extrabold text-gray-900 leading-tight">dăhdhawuidhoawhdoahdoawodhawohdoawdhoaw</h3>
            <span className="bg-purple-100 text-[#6E55FB] px-2 py-1.5 rounded-full text-sm font-bold whitespace-nowrap">
