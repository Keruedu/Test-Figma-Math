...
const packages: Package[] = [
  {
    id: 1,
    name: 'Gói Cơ bản',
    description: 'Phù hợp cho học sinh mới bắt đầu',
    pointCost: 500,
    features: ['30 ngày truy cập', '100 bài tập', 'Hỗ trợ cơ bản'],
    isPopular: false,
    status: 'active'
  },
  {
    ...
    pointCost: 1000,
    features: ['60 ngày truy cập', '500 bài tập', 'Hỗ trợ ưu tiên', 'Thi thử không giới hạn'],
    isPopular: true,
    status: 'active'
  },
  {
    id: 3,
    name: 'Gói Nâng cao',
    description: 'Dành cho học sinh chuyên nghiệp',
    pointCost: 2000,
    features: ['90 ngày truy cập', 'Không giới hạn bài tập', 'Hỗ trợ VIP 24/7', 'Tài liệu độc quyền', 'Chứng chỉ hoàn thành'],
    isPopular: false,
    status: 'active'
  },
  {
    id: 4,
    name: 'Gói Premium',
    description: 'Trọn bộ tính năng cao cấp',
    pointCost: 3500,
    features: ['180 ngày truy cập', 'Tất cả tính năng', '1-1 Coaching', 'Ưu tiên mọi sự kiện', 'Badge đặc biệt'],
    isPopular: false,
    status: 'active'
  }
]
