      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-12">
          ...
          <div className="space-y-16">
              ...
              <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('lobby'); }}>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  {['🎯 Minh Anh', '🚀 Tuấn Kiệt', '⭐ Hương Giang'].map((player, i) => (
                    <div key={i} className="bg-gray-50 rounded-xl p-2 text-center text-gray-800 text-sm border border-gray-200">{player}</div>
                  ))}
                </div>
            ...
            {/* All Question Types - Full Display */}
            <div className="animate-fade-slide animate-delay-400">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">5 loại câu hỏi đa dạng - Xem chi tiết từng màn hình</p>
              </div>
              
              <div className="space-y-12 max-w-6xl mx-auto">{/* Multiple Choice Full */}
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <span className="inline-block px-4 py-2 rounded-full bg-blue-100 text-blue-600 text-sm font-semibold mb-2">
                        📝 Trắc nghiệm
                      </span>
                      <h3 className="text-3xl font-bold text-gray-800">125 + 47 = ?</h3>
                    </div>
                    <div className="text-right">
                      <div className="bg-purple-100 px-4 py-2 rounded-lg mb-2">
                        <span className="text-gray-600 text-sm">Câu 1/10</span>
                      </div>
                      <div className="bg-red-100 px-4 py-2 rounded-lg">
                        <span className="text-red-600 font-bold">⏱️ 00:25</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-4 hover:border-gray-300 transition-all">
                      <span className="text-gray-500 font-bold mr-3">A.</span>
                      <span className="text-gray-800 font-medium">162</span>
                    </div>
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-green-600 font-bold mr-3">B.</span>
                          <span className="text-green-700 font-medium">172</span>
                        </div>
                        <span className="text-green-600 text-2xl">✓</span>
                      </div>
                    </div>
                    <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-4">
                      <span className="text-gray-500 font-bold mr-3">C.</span>
                      <span className="text-gray-800 font-medium">182</span>
                    </div>
                    <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-4">
                      <span className="text-gray-500 font-bold mr-3">D.</span>
                      <span className="text-gray-800 font-medium">152</span>
                    </div>
                  </div>
                  <div className="bg-green-50 border border-green-200 rounded-xl p-3">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">Câu trả lời của bạn: <span className="text-green-600 font-semibold">B</span></span>
                      <span className="text-gray-600">Đáp án đúng: <span className="text-green-600 font-semibold">B</span></span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <span className="inline-block px-4 py-2 rounded-full bg-purple-100 text-purple-600 text-sm font-semibold mb-2">
                        ✍️ Tự luận
                      </span>
                      <h3 className="text-3xl font-bold text-gray-800">Nếu x + 15 = 42, thì x = ?</h3>
                    </div>
                    <div className="text-right">
                      <div className="bg-purple-100 px-4 py-2 rounded-lg mb-2">
                        <span className="text-gray-600 text-sm">Câu 2/10</span>
                      </div>
                      <div className="bg-orange-100 px-4 py-2 rounded-lg">
                        <span className="text-orange-600 font-bold">⏱️ 00:18</span>
                      </div>
                    </div>
                  </div>
                  <input
                    ...
                    value="27"
                    placeholder="Nhập đáp án của bạn..."
                    className="w-full px-8 py-6 rounded-xl bg-gray-50 border-2 border-gray-200 text-gray-800 text-2xl text-center mb-4"
                    disabled
                  />
                  <button className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-white font-bold py-4 rounded-xl mb-4" disabled>
                    ✓ Gửi đáp án
                  </button>
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                    <p className="text-green-600 font-bold text-center text-xl">🎉 Chính xác!</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <span className="inline-block px-4 py-2 rounded-full bg-yellow-100 text-yellow-700 text-sm font-semibold mb-2">
                        ✓✗ Đúng/Sai
                      </span>
                      <h3 className="text-3xl font-bold text-gray-800">Tổng các góc trong tam giác luôn bằng 180 độ</h3>
                    </div>
                    <div className="text-right">
                      <div className="bg-purple-100 px-4 py-2 rounded-lg mb-2">
                        <span className="text-gray-600 text-sm">Câu 3/10</span>
                      </div>
                      <div className="bg-green-100 px-4 py-2 rounded-lg">
                        <span className="text-green-600 font-bold">⏱️ 00:22</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-8">
                      <div className="text-center relative">
                        <span className="text-6xl text-green-500 mb-4 block">✓</span>
                        <span className="text-2xl font-bold text-green-700">ĐÚNG</span>
                        <span className="absolute top-2 right-2 inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500 text-white">✓</span>
                      </div>
                    </div>
                    <div className="bg-gray-50 border-2 border-gray-200 rounded-xl p-8">
                      <div className="text-center">
                        ...
                        <span className="text-2xl font-bold text-gray-600">SAI</span>
                      </div>
                    </div>
                  </div>
                  <div className="bg-green-50 border border-green-200 rounded-xl p-3">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">Câu trả lời của bạn: <span className="text-green-600 font-semibold">ĐÚNG</span></span>
                      <span className="text-gray-600">Đáp án đúng: <span className="text-green-600 font-semibold">ĐÚNG</span></span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <span className="inline-block px-4 py-2 rounded-full bg-pink-100 text-pink-600 text-sm font-semibold mb-2">
                        🔗 Ghép cột
                      </span>
                      <h3 className="text-3xl font-bold text-gray-800">Ghép các phép tính với kết quả đúng</h3>
                    </div>
                    <div className="text-right">
                      <div className="bg-purple-100 px-4 py-2 rounded-lg mb-2">
                        <span className="text-gray-600 text-sm">Câu 4/10</span>
                      </div>
                      <div className="bg-red-100 px-4 py-2 rounded-lg">
                        <span className="text-red-600 font-bold">⏱️ 00:15</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    <div className="space-y-3">
                      <div className="bg-blue-50 px-3 py-2 rounded-lg border border-blue-200">
                        <span className="text-blue-700 font-semibold text-sm">Cột A</span>
                      </div>
                      <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                        <span className="text-gray-800 font-semibold">5 × 6</span>
                        <div className="mt-2 text-sm text-green-600">→ 30</div>
                      </div>
                      <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                        <span className="text-gray-800 font-semibold">8 × 7</span>
                        <div className="mt-2 text-sm text-green-600">→ 56</div>
                      </div>
                      <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                        <span className="text-gray-800 font-semibold">9 × 4</span>
                        <div className="mt-2 text-sm text-green-600">→ 36</div>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="bg-purple-50 px-3 py-2 rounded-lg border border-purple-200">
                        <span className="text-purple-700 font-semibold text-sm">Cột B</span>
                      </div>
                      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                        <span className="text-gray-800 font-semibold">36</span>
                      </div>
                      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                        <span className="text-gray-800 font-semibold">56</span>
                      </div>
                      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                  ...
                  <button className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-white font-bold py-4 rounded-xl" disabled>
                    ✓ Gửi đáp án (3/3)
                  </button>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <span className="inline-block px-4 py-2 rounded-full bg-indigo-100 text-indigo-600 text-sm font-semibold mb-2">
                        🔢 Sắp xếp
                      </span>
                      <h3 className="text-3xl font-bold text-gray-800">Sắp xếp các số sau theo thứ tự tăng dần</h3>
                    </div>
                    <div className="text-right">
                      <div className="bg-purple-100 px-4 py-2 rounded-lg mb-2">
                        <span className="text-gray-600 text-sm">Câu 5/10</span>
                      </div>
                      <div className="bg-orange-100 px-4 py-2 rounded-lg">
                        <span className="text-orange-600 font-bold">⏱️ 00:20</span>
                      </div>
                    </div>
                  </div>
                  <div className="bg-blue-50 border border-blue-200 p-3 rounded-xl mb-4">
                    <p className="text-gray-700 text-sm">💡 Kéo thả để sắp xếp các mục theo thứ tự đúng</p>
                  </div>
                  <div className="space-y-3 mb-4">
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                      <div className="flex items-center gap-4">
                        <span className="text-2xl font-bold bg-green-200 w-12 h-12 rounded-lg flex items-center justify-center text-green-700">1</span>
                        <span className="text-xl font-semibold text-gray-800 flex-1">47</span>
                        <span className="text-2xl text-green-500">✓</span>
                      </div>
                    </div>
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                      <div className="flex items-center gap-4">
                        <span className="text-2xl font-bold bg-green-200 w-12 h-12 rounded-lg flex items-center justify-center text-green-700">2</span>
                        <span className="text-xl font-semibold text-gray-800 flex-1">89</span>
                        <span className="text-2xl text-green-500">✓</span>
                      </div>
                    </div>
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                      <div className="flex items-center gap-4">
                        <span className="text-2xl font-bold bg-green-200 w-12 h-12 rounded-lg flex items-center justify-center text-green-700">3</span>
                        <span className="text-xl font-semibold text-gray-800 flex-1">125</span>
                        <span className="text-2xl text-green-500">✓</span>
                      </div>
                    </div>
                    <div className="bg-green-50 border-2 border-green-500 rounded-xl p-4">
                      <div className="flex items-center gap-4">
                        <span className="text-2xl font-bold bg-green-200 w-12 h-12 rounded-lg flex items-center justify-center text-green-700">4</span>
                        <span className="text-xl font-semibold text-gray-800 flex-1">256</span>
                        <span className="text-2xl text-green-500">✓</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('leaderboard'); }}>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    { pos: 3, avatar: '⭐', name: 'Hương Giang', score: 300, color: 'bg-orange-400' },
                    { pos: 4, avatar: '🎨', name: 'Thu Hà', score: 250, color: 'bg-gray-200' },
                    { pos: 5, avatar: '🎮', name: 'Đức Anh', score: 200, color: 'bg-gray-200' },
                  ].map((player) => (
                    <div key={player.pos} className={player.pos === 1 ? 'bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] p-4 rounded-xl scale-105 shadow-lg' : 'bg-gray-50 p-4 rounded-xl border border-gray-200'}>
                      <div className="flex items-center gap-4">
                        <div className={`${player.color} w-10 h-10 rounded-lg flex items-center justify-center text-xl font-bold ${player.pos === 1 ? 'text-yellow-900' : 'text-gray-700'}`}>{player.pos}</div>
            ...
            <div className="animate-fade-slide animate-delay-800">
              ...
              <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('results'); }}>
                ...
                <p className="text-xl text-green-600 text-center mb-8">Chúc mừng! Bạn đã hoàn thành trận đấu!</p>
                ...
                <div className="flex items-end justify-center gap-4 mb-8">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-gradient-to-br from-gray-300 to-gray-500 w-24 h-32 rounded-t-2xl flex flex-col items-center justify-center shadow-lg">
                      ...
                      <span className="text-white font-semibold text-sm">Tuấn Kiệt</span>
                  ...
                  <div className="flex flex-col items-center -mt-6">
                    ...
                    <div className="bg-gradient-to-br from-yellow-300 to-yellow-500 w-20 h-20 rounded-full flex items-center justify-center text-4xl mb-2 shadow-xl">🎯</div>
                    <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 w-28 h-44 rounded-t-2xl flex flex-col items-center justify-center shadow-xl">
                      <span className="text-4xl font-bold text-yellow-900">1</span>
                      <span className="text-yellow-900 font-bold">Minh Anh</span>
                      <span className="text-yellow-900 font-bold text-xl">500</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-gradient-to-br from-orange-400 to-orange-700 w-24 h-24 rounded-t-2xl flex flex-col items-center justify-center shadow-lg">
                      ...
                      <span className="text-white font-semibold text-sm">Hương Giang</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-white font-bold py-3 rounded-xl hover:shadow-lg transition-all" disabled>
                    🔄 Chơi lại
                  </button>
            ...
            <div className="animate-fade-slide animate-delay-800">
              ...
              <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/10 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('results'); }}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button className="bg-gray-100 text-gray-800 font-bold py-3 rounded-xl border-2 border-gray-300" disabled>
                    🚪 Thoát
                  </button>
                </div>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 bg-white shadow-lg text-gray-800 px-4 py-2 rounded-lg hover:shadow-xl transition-all flex items-center gap-2 border border-gray-200"
      >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-32 left-1/4 text-7xl opacity-10 animate-float text-[#6E55FB]" style={{ animationDelay: '2s' }}>∞</div>
        <div className="absolute bottom-20 right-1/3 text-5xl opacity-10 animate-float text-[#6E55FB]" style={{ animationDelay: '1.5s' }}>√</div>
        <div className="absolute top-1/2 right-10 text-6xl opacity-10 animate-float text-[#6E55FB]" style={{ animationDelay: '0.5s' }}>+</div>
        <div className="absolute top-2/3 left-10 text-5xl opacity-10 animate-float text-[#6E55FB]" style={{ animationDelay: '2.5s' }}>×</div>
      </div>
      ...
      {screen === 'lobby' && (
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center mb-8 animate-fade-slide">
            ...
            <div className="inline-block bg-purple-50 px-8 py-4 rounded-2xl border-2 border-[#6E55FB]">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 animate-fade-slide animate-delay-200">
            <input
              ...
              className="w-full px-6 py-4 rounded-xl bg-gray-50 border-2 border-gray-200 text-gray-800 text-lg placeholder-gray-400 focus:outline-none focus:border-[#6E55FB] transition-all mb-6"
            />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-64 overflow-y-auto">
                {players.map((player, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-800 font-medium truncate">{player.name}</span>
                  </div>
                ))}
              </div>
            </div>
