  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        ...
        { id: 'C', text: '75%', isCorrect: true },
        { id: 'D', text: '80%', isCorrect: false },
      ],
    },
    {
      text: 'Chu vi hình vuông cạnh 8cm là?',
      answers: [
        { id: 'A', text: '24cm', isCorrect: false },
        { id: 'B', text: '32cm', isCorrect: true },
        { id: 'C', text: '64cm', isCorrect: false },
        { id: 'D', text: '16cm', isCorrect: false },
      ],
    },
    {
      text: 'Diện tích hình tròn bán kính 5cm? (π ≈ 3.14)',
      answers: [
        { id: 'A', text: '31.4 cm²', isCorrect: false },
        { id: 'B', text: '78.5 cm²', isCorrect: true },
    ...
    {
      text: 'Trung bình cộng của 10, 15, 20 là?',
      answers: [
