...
import type { GameScreen } from './types'import type { GameScreen } from './types'
...
function App() {function App() {
  ...
  const [showLanding, setShowLanding] = useState(true)  const [showLanding, setShowLanding] = useState(true)

  const [currentScreen, setCurrentScreen] = useState<GameScreen>('lobby')  const [currentScreen, setCurrentScreen] = useState<GameScreen>('lobby')
  ...
  const handleNavigate = (screen: GameScreen, questionIndex?: number) => {  const handleNavigate = (screen: GameScreen, questionIndex?: number) => {

    setShowLanding(false)    setShowLanding(false)

    setCurrentScreen(screen)    setCurrentScreen(screen)

    if (questionIndex !== undefined) {    if (questionIndex !== undefined) {

      setCurrentQuestionIndex(questionIndex)      setCurrentQuestionIndex(questionIndex)
  ...
  if (showLanding) {  if (showLanding) {
    ...
    return <LandingPage onNavigate={handleNavigate} />    return <LandingPage onNavigate={handleNavigate} />
  ...
  return (  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50">    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50">

      {/* Back to Landing Button */}      {/* Back to Landing Button */}

      <button      <button

        onClick={() => setShowLanding(true)}        onClick={() => setShowLanding(true)}

        className="fixed top-4 left-4 z-50 bg-white text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-100 transition-all flex items-center gap-2 shadow-lg border border-gray-200"        className="fixed top-4 left-4 z-50 bg-white text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-100 transition-all flex items-center gap-2 shadow-lg border border-gray-200"

      >      >

        <span>←</span> Về trang chủ        <span>←</span> Về trang chủ

      </button>      </button>



      <div className="pt-20 px-4">      <div className="pt-20 px-4">

        <div className="max-w-4xl mx-auto bg-white rounded-2xl p-8 shadow-xl border border-gray-200">        <div className="max-w-4xl mx-auto bg-white rounded-2xl p-8 shadow-xl border border-gray-200">

          <h2 className="text-3xl font-bold text-gray-900 mb-4">          <h2 className="text-3xl font-bold text-gray-900 mb-4">

            {currentScreen === 'lobby' && '🏠 Sảnh chờ'}            {currentScreen === 'lobby' && '🏠 Sảnh chờ'}

            {currentScreen === 'game' && '🎮 Trò chơi'}            {currentScreen === 'game' && '🎮 Trò chơi'}

            {currentScreen === 'leaderboard' && '📊 Bảng xếp hạng'}            {currentScreen === 'leaderboard' && '📊 Bảng xếp hạng'}

            {currentScreen === 'results' && '🏆 Kết quả'}            {currentScreen === 'results' && '🏆 Kết quả'}

          </h2>          </h2>

          <p className="text-gray-600">          <p className="text-gray-600">

            Màn hình <strong>{currentScreen}</strong> đang được phát triển...            Màn hình <strong>{currentScreen}</strong> đang được phát triển...
          ...
          {currentScreen === 'game' && (          {currentScreen === 'game' && (
            ...
            <p className="text-gray-600 mt-2">            <p className="text-gray-600 mt-2">
              ...
              Câu hỏi số: <strong>{currentQuestionIndex + 1}</strong>              Câu hỏi số: <strong>{currentQuestionIndex + 1}</strong>
        ...
        <div className="relative z-10 container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-16 animate-fade-slide">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 text-xl font-bold py-4 px-12 rounded-xl hover:shadow-lg hover:shadow-[#6E55FB]/50 transition-all transform hover:scale-105 active:scale-95"
            >
              🚀 Bắt đầu trải nghiệm
            </button>
          </div>
          ...
          <div className="space-y-16">
            ...
            <div className="animate-fade-slide animate-delay-200">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Người chơi nhập tên và chờ trận đấu bắt đầm</p>
              </div>
              <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('lobby'); }}>
                <div className="text-center mb-6">
                  ...
                  <div className="inline-block bg-purple-50 backdrop-blur-sm px-6 py-3 rounded-2xl border-2 border-[#6E55FB]">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  {['🎯 Minh Anh', '🚀 Tuấn Kiệt', '⭐ Hương Giang'].map((player, i) => (
                    <div key={i} className="bg-gray-50 rounded-xl p-2 text-center text-gray-900 text-sm border border-gray-200">{player}</div>
                  ))}
                </div>
                <button className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 font-bold py-3 rounded-xl" disabled>
                  🚀 Sẵn sàng!
                </button>
              </div>
            </div>
            ...
            <div className="animate-fade-slide animate-delay-400">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">5 loại câu hỏi đa dạng và hấp dẫn - Click để xem chi tiết</p>
              </div>

              {/* Multiple Choice - Full Screen */}
              <div className="mb-16">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">📝 Trắc nghiệm</h3>
                  <p className="text-gray-600">Chọn đáp án đúng từ 4 lựa chọn</p>
                </div>
                <div className="max-w-5xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(0); setShowFeedback(true); setSelectedAnswer('B'); }}>
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">125 + 47 = ?</h2>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="p-6 rounded-2xl bg-gray-50 border-2 border-gray-200 text-left">
                    ...
                    <div className="p-6 rounded-2xl bg-green-50 border-2 border-green-500 text-left">
                      <div className="flex items-center gap-4">
                        <span className="text-xl font-bold text-green-600">C.</span>
                        <span className="text-xl font-medium text-green-700">172</span>
                        <span className="ml-auto">
                          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500 text-gray-900">✓</span>
                        </span>
                      </div>
                    </div>
                    <div className="p-6 rounded-2xl bg-white border-2 border-gray-300 text-left">
                      <div className="flex items-center gap-4">
                        <span className="text-xl font-bold text-gray-500">D.</span>
                        <span className="text-xl font-medium text-gray-900">152</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mb-16">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">✍️ Tự luận</h3>
                  <p className="text-gray-500">Nhập trực tiếp đáp án vào ô trống</p>
                </div>
                <div className="max-w-5xl mx-auto bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(1); }}>
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 border-2 border-gray-300">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">Nếu x + 15 = 42, thì x = ?</h2>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <input
                      ...
                      placeholder="Nhập đáp án của bạn..."
                      value="27"
                      className="w-full px-8 py-6 rounded-2xl bg-gray-50 border-2 border-gray-300 text-gray-900 text-2xl text-center placeholder-gray-400"
                      disabled
                    />
              ...
              <div className="mb-16">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">✓✗ Đúng/Sai</h3>
                  <p className="text-gray-500">Chọn câu trả lời đúng hoặc sai</p>
                </div>
                <div className="max-w-5xl mx-auto bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(2); }}>
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 border-2 border-gray-300">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">Tổng các góc trong tam giác luôn bằng 180 độ</h2>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div className="relative p-8 rounded-2xl bg-green-100/10 border-2 border-green-500">
                        ...
                        <span className="absolute top-4 right-4">
                          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500 text-gray-900 text-xl">✓</span>
                        </span>
                      </div>
                      <div className="relative p-8 rounded-2xl bg-white border-2 border-gray-300">
                        <div className="text-center">
              ...
              <div className="mb-16">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">🔗 Ghép cột</h3>
                  <p className="text-gray-500">Nối các mục ở cột A với cột B</p>
                </div>
                <div className="max-w-5xl mx-auto bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(3); }}>
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 border-2 border-gray-300">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">Ghép các phép tính với kết quả đúng</h2>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-green-500/30 border-2 border-green-500 p-4 rounded-xl">
                          <span className="text-gray-900 font-semibold text-lg">8 × 7</span>
                          <div className="mt-2 text-sm text-blue-300">→ 56</div>
                        </div>
                        <div className="bg-green-500/30 border-2 border-green-500 p-4 rounded-xl">
                          <span className="text-gray-900 font-semibold text-lg">9 × 4</span>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-purple-500/20 border-2 border-purple-500/50 p-4 rounded-xl">
                          <span className="text-gray-900 font-semibold text-lg">36</span>
                        </div>
                        <div className="bg-purple-500/20 border-2 border-purple-500/50 p-4 rounded-xl">
                          <span className="text-gray-900 font-semibold text-lg">56</span>
                        </div>
                        <div className="bg-purple-500/20 border-2 border-purple-500/50 p-4 rounded-xl">
              ...
              <div className="mb-16">
                <div className="text-center mb-6">
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">🔢 Sắp xếp</h3>
                  <p className="text-gray-500">Kéo thả để sắp xếp theo thứ tự đúng</p>
                </div>
                <div className="max-w-5xl mx-auto bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('game'); setCurrentQuestion(4); }}>
                  <div className="flex items-start justify-between mb-8">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 border-2 border-gray-300">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">Sắp xếp các số sau theo thứ tự tăng dần</h2>
                    </div>
                  </div>
                  
                  <div className="space-y-6">
                    <div className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
                      <p className="text-gray-600 text-sm">💡 Kéo thả để sắp xếp các mục theo thứ tự đúng</p>
                    </div>
                    <div className="space-y-3">
                      <div className="relative p-6 rounded-xl bg-green-500/30 border-2 border-green-500">
                        <div className="flex items-center gap-4">
                          <span className="text-3xl font-bold bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center">1</span>
                          <span className="text-xl md:text-2xl font-semibold text-gray-900 flex-1">47</span>
                        </div>
                        <span className="absolute top-4 right-4 text-3xl">✓</span>
                      </div>
                      <div className="relative p-6 rounded-xl bg-green-500/30 border-2 border-green-500">
                        <div className="flex items-center gap-4">
                          <span className="text-3xl font-bold bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center">2</span>
                          <span className="text-xl md:text-2xl font-semibold text-gray-900 flex-1">89</span>
                        </div>
                        <span className="absolute top-4 right-4 text-3xl">✓</span>
                      </div>
                      <div className="relative p-6 rounded-xl bg-green-500/30 border-2 border-green-500">
                        <div className="flex items-center gap-4">
                          <span className="text-3xl font-bold bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center">3</span>
                          <span className="text-xl md:text-2xl font-semibold text-gray-900 flex-1">125</span>
                        </div>
                        <span className="absolute top-4 right-4 text-3xl">✓</span>
                      </div>
                      <div className="relative p-6 rounded-xl bg-green-500/30 border-2 border-green-500">
                        <div className="flex items-center gap-4">
                          <span className="text-3xl font-bold bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center">4</span>
                          <span className="text-xl md:text-2xl font-semibold text-gray-900 flex-1">256</span>
                        </div>
                        <span className="absolute top-4 right-4 text-3xl">✓</span>
                      </div>
                    </div>
            ...
            <div className="animate-fade-slide animate-delay-600">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500">Xem thứ hạng sau mỗi câu hỏi</p>
              </div>
              <div className="max-w-3xl mx-auto bg-white  rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('leaderboard'); }}>
                <h3 className="text-3xl font-bold text-gray-900 text-center mb-6">📊 Bảng xếp hạng tạm thời</h3>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={player.pos} className={player.pos === 1 ? 'bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] p-4 rounded-xl' : 'bg-gray-50 p-4 rounded-xl'}>
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-gray-900 font-semibold flex-1">{player.name}</span>
                        <span className="text-gray-900 font-bold">{player.score} điểm</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="animate-fade-slide animate-delay-800">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500">Bục vinh quang và xếp hạng cuối cùng</p>
              </div>
              <div className="max-w-4xl mx-auto bg-white  rounded-3xl p-8 shadow-2xl border border-gray-200 hover:scale-105 transition-all cursor-pointer" onClick={() => { setLandingView(false); setScreen('results'); }}>
                <h3 className="text-4xl font-bold text-gray-900 text-center mb-3">🏆 Kết quả chung cuộc</h3>
                ...
                <div className="flex items-end justify-center gap-4 mb-8">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="bg-gradient-to-br from-gray-300 to-gray-500 w-24 h-32 rounded-t-2xl flex flex-col items-center justify-center">
                      ...
                      <span className="text-gray-900 text-sm">400</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 font-bold py-3 rounded-xl" disabled>
                    🔄 Chơi lại
                  </button>
                  <button className="bg-gray-50 text-gray-900 font-bold py-3 rounded-xl border border-gray-300" disabled>
                    🚪 Thoát
                  </button>
                </div>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50 relative overflow-hidden">
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 bg-gray-50 backdrop-blur-sm text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-100 transition-all flex items-center gap-2"
      >
      ...
      {screen === 'lobby' && (
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center mb-8 animate-fade-slide">
            ...
            <div className="inline-block bg-gray-50 backdrop-blur-sm px-8 py-4 rounded-2xl border-2 border-[#6E55FB]">
          ...
          <div className="bg-white  rounded-3xl p-8 shadow-2xl border border-gray-200 animate-fade-slide animate-delay-200">
            <input
              ...
              className="w-full px-6 py-4 rounded-xl bg-gray-50 border-2 border-gray-300 text-gray-900 text-lg placeholder-gray-400 focus:outline-none focus:border-[#6E55FB] transition-all mb-6"
            />
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-64 overflow-y-auto">
                {players.map((player, index) => (
                  <div
                    key={player.id}
                    className="bg-gray-50 rounded-xl p-3 flex items-center gap-3 animate-fade-slide hover:bg-gray-100 transition-all"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 text-xl font-bold py-5 rounded-xl hover:shadow-lg hover:shadow-[#6E55FB]/50 transition-all transform hover:scale-105 active:scale-95"
            >
              🚀 Sẵn sàng!
            </button>
          </div>
      ...
      {screen === 'game' && question && (
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-5xl">
          <div className="flex justify-between items-center mb-6 animate-fade-slide">
            <div className="bg-gray-50 backdrop-blur-sm px-6 py-3 rounded-xl">
              <p className="text-gray-900 font-bold text-lg">Câu {currentQuestion + 1}/{totalQuestions}</p>
            </div>
            <div className={`bg-gray-50 backdrop-blur-sm px-8 py-3 rounded-xl border-2 ${timer < 10 ? 'border-red-500 animate-pulse' : 'border-gray-300'}`}>
              <p className={`font-bold text-2xl ${timer < 10 ? 'text-red-400' : 'text-gray-900'}`}>⏱️ 00:{timer.toString().padStart(2, '0')}</p>
            </div>
            <div className="bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] px-6 py-3 rounded-xl">
              <p className="text-gray-900 font-bold text-lg">🏆 {currentScore} điểm</p>
            </div>
          </div>
          ...
          <div className="bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 mb-6 animate-fade-slide animate-delay-200">
            <div className="flex items-start justify-between mb-8">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-6">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-50 border-2 border-gray-300">
                    <span className="text-xl font-bold text-gray-900">{currentQuestion + 1}</span>
                  </div>
                  <span className="inline-block px-4 py-2 rounded-full bg-[#6E55FB]/20 text-[#6E55FB] text-sm font-semibold border border-[#6E55FB]/30">
                ...
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8">{question.text}</h2>
              </div>
              
              {showFeedback && (
                <button
                  onClick={() => setShowFeedback(false)}
                  className="ml-4 flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 hover:bg-gray-100 transition-all"
                >
            ...
            {question.type === 'multiple-choice' && (
              <div>
                      ...
                      <button
                        ...
                        className={`relative p-6 rounded-2xl transition-all transform hover:scale-105 active:scale-95 animate-fade-slide text-left ${
                          showCorrect
                            ...
                            : 'bg-white border-2 border-gray-300 hover:border-white/40'
                        } disabled:cursor-not-allowed`}
                        style={{ animationDelay: `${0.3 + index * 0.1}s` }}
                      >
                        <div className="flex items-center gap-4">
                          <span className={`text-xl font-bold ${
                            showCorrect ? 'text-green-400' : showWrong ? 'text-red-400' : 'text-gray-500'
                          }`}>
                            {answer.id}.
                          </span>
                          <span className={`text-xl font-medium ${
                            showCorrect ? 'text-green-300' : showWrong ? 'text-red-300' : 'text-gray-900'
                          }`}>
                            {answer.text}
                          </span>
                          {showCorrect && (
                          ...
                          {showWrong && (
                            <span className="ml-auto text-2xl">
                              <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-500 text-gray-900">✗</span>
                            </span>
                          )}
                        </div>
                      </button>
                ...
                {showFeedback && (
                  <div className="bg-white border border-gray-200 rounded-xl p-4 animate-fade-slide">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-500">
            ...
            {question.type === 'text-input' && (
              <div className="space-y-6">
                <input
                  ...
                  disabled={showFeedback}
                  className="w-full px-8 py-6 rounded-2xl bg-gray-50 border-2 border-gray-300 text-gray-900 text-2xl text-center placeholder-gray-400 focus:outline-none focus:border-[#6E55FB] transition-all disabled:cursor-not-allowed"
                />
                {!showFeedback && (
                  <button
                    onClick={handleTextSubmit}
                    disabled={!textAnswer.trim()}
                    className="w-full bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 text-xl font-bold py-5 rounded-xl hover:shadow-lg hover:shadow-[#6E55FB]/50 transition-all transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    ✓ Gửi đáp án
                  </button>
                )}
              ...
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  >
                    ...
                    {showFeedback && selectedAnswer === 'true' && !question.correctAnswer && (
                      <span className="absolute top-4 right-4">
                        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-500 text-gray-900 text-xl">✗</span>
                      </span>
                    )}
                  </button>
                  <button
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-4 rounded-xl transition-all transform hover:scale-105 text-left animate-fade-slide ${
                            ...
                            'bg-gray-50 border-2 border-gray-300 hover:border-[#6E55FB]'
                          } disabled:cursor-not-allowed`}
                          style={{ animationDelay: `${0.3 + index * 0.1}s` }}
                        >
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-4 rounded-xl transition-all transform hover:scale-105 text-left animate-fade-slide ${
                            ...
                            canSelect ? 'bg-gray-50 border-2 border-gray-300 hover:border-purple-500' :
                    ...
                    return (
                      <div
                        ...
                        className={`relative p-6 rounded-xl transition-all cursor-move animate-fade-slide ${
                          ...
                          'bg-gray-50 border-2 border-gray-300 hover:border-[#6E55FB] hover:scale-105'
                        } ${showFeedback ? 'cursor-default' : ''}`}
                        style={{ animationDelay: `${0.3 + index * 0.1}s` }}
                      >
                        <div className="flex items-center gap-4">
                          <span className="text-3xl font-bold bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center">
                            {index + 1}
                          </span>
                          <span className="text-xl md:text-2xl font-semibold text-gray-900 flex-1">{item.text}</span>
                          {!showFeedback && (
      ...
      {screen === 'leaderboard' && (
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-3xl flex items-center justify-center min-h-screen">
          <div className="bg-white  rounded-3xl p-8 shadow-2xl border border-gray-200 w-full animate-fade-slide">
            <h2 className="text-4xl font-bold text-gray-900 text-center mb-8">📊 Bảng xếp hạng tạm thời</h2>
              ...
              {leaderboard.slice(0, 5).map((player, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-3xl">{player.avatar}</span>
                    <span className="text-gray-900 font-semibold text-lg flex-1">{player.name}</span>
                    <span className="text-gray-900 font-bold text-xl">{player.score} điểm</span>
                  </div>
                )
              })}
            </div>
      ...
      {screen === 'results' && (
        <div className="relative z-10 container mx-auto px-4 py-8 max-w-4xl flex items-center justify-center min-h-screen">
          <div className="bg-white  rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 w-full animate-fade-slide">
            <h2 className="text-5xl font-bold text-gray-900 text-center mb-4">🏆 Kết quả chung cuộc</h2>
            ...
            <div className="flex items-end justify-center gap-4 mb-12 animate-fade-slide animate-delay-400">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="bg-gradient-to-br from-gray-300 to-gray-500 w-24 md:w-32 h-32 md:h-40 rounded-t-2xl flex flex-col items-center justify-center">
                  ...
                  <span className="text-gray-900 font-semibold text-sm md:text-base">{leaderboard[1]?.name}</span>
                  <span className="text-gray-900 font-bold text-lg md:text-xl">{leaderboard[1]?.score}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="bg-gradient-to-br from-orange-400 to-orange-700 w-24 md:w-32 h-24 md:h-32 rounded-t-2xl flex flex-col items-center justify-center">
                  ...
                  <span className="text-gray-900 font-semibold text-sm md:text-base">{leaderboard[2]?.name}</span>
                  <span className="text-gray-900 font-bold text-lg md:text-xl">{leaderboard[2]?.score}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 animate-fade-slide animate-delay-600">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-[#6E55FB] to-[#8b6fff] text-gray-900 text-xl font-bold py-5 rounded-xl hover:shadow-lg hover:shadow-[#6E55FB]/50 transition-all transform hover:scale-105 active:scale-95"
              >
                🔄 Chơi lại
              </button>
              <button
                onClick={() => alert('Thoát khỏi trò chơi')}
                className="flex-1 bg-gray-50 backdrop-blur-sm text-gray-900 text-xl font-bold py-5 rounded-xl hover:bg-gray-100 transition-all transform hover:scale-105 active:scale-95 border border-gray-300"
              >
                🚪 Thoát
              </button>
            </div>
